...
@section('content')
    <div class="header">
        <div class="title-section">
            ...
            <p class="subtle">Perbarui informasi untuk: <strong>{{ $kampus->nama_kampus }}</strong></p>
        </div>
        <div class="controls">
        ...
        <form action="{{ route('admin.kampus.update', $kampus->id) }}" method="POST">
            ...
            <div class="row g-4">
                <div class="col-md-8">
                    ...
                    <input type="text" name="nama_kampus" id="nama_kampus" class="form-control form-control-lg" value="{{ $kampus->nama_kampus }}" required>
                </div>
                <div class="col-md-4">
                    <label for="kode_kampus" class="form-label fw-bold">Kode Kampus</label>
                    <input type="text" name="kode_kampus" id="kode_kampus" class="form-control form-control-lg" value="{{ $kampus->kode_kampus }}">
                </div>
            </div>
